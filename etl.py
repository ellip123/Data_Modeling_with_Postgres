...
def process_song_file(cur, filepath):
    ...
    artist_data_values = df[['artist_id','artist_name','artist_location','artist_latitude','artist_longitude']].values
    first_records = artist_data_values[0]
    artist_data = first_records.tolist()
...
def process_log_file(cur, filepath):
    ...
    time_data = []
    for each in t:
        time_data.append([each,each.hour, each.day,each.weekofyear,each.month, each.year,each.dayofweek])
